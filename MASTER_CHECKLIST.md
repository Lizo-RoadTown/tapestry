...
- [~] **Step 3** — project-registry — **lift DONE 2026-06-20** (branch `migration/03-project-registry`, PR open): `services/project-registry/` verbatim Lift + `002_init_projects.sql` forklift + render.yaml staging entry. Runbook `proposed`. No deploy. **Net-new signup endpoint deferred.** Runbook: `runbooks/03-project-registry.md`.
