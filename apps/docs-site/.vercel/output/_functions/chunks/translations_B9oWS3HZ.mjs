...
import { d as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_BMQSOHms.mjs';
import { V as VALID_INPUT_FORMATS } from './consts_Bd-1c2lz.mjs';
import { o as AstroError, U as UnknownContentCollectionError, c as createComponent, y as RenderUndefinedEntryError, u as unescapeHTML, a as renderTemplate, z as renderUniqueStylesheet, B as renderScriptElement, C as createHeadAndContent, r as renderComponent, A as AstroUserError } from './astro/server_DpMYLMcY.mjs';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DqAqP9nA.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://tapestry-khaki.vercel.app", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_DrcmpUp5.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_A3Td_nxV.mjs');
...
const starlightConfig = {"description":"What keeps a project on track when it plugs into the Tapestry platform: the discipline stack of plugins, MCP wiring, hooks, and project intelligence — and how to recover when one piece goes missing.","social":[{"icon":"github","label":"GitHub","href":"https://github.com/Lizo-RoadTown/tapestry"}],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Learn","translations":{},"collapsed":false,"items":[{"label":"User-agent interface","translations":{},"slug":"start/user-agent-interface","attrs":{}},{"label":"The signal hierarchy","translations":{},"slug":"explanation/signal-hierarchy","attrs":{}},{"label":"Signal → Interpretation → Pattern","translations":{},"slug":"explanation/signal-interpretation-pattern","attrs":{}},{"label":"The observer","translations":{},"slug":"explanation/the-observer","attrs":{}},{"label":"Observer-derived intent","translations":{},"slug":"explanation/observer-derived-intent","attrs":{}},{"label":"Observatory lenses","translations":{},"slug":"explanation/observatory-lenses","attrs":{}},{"label":"Names you'll see in these docs","translations":{},"slug":"start/names-you-will-see","attrs":{}}]},{"label":"Docs","translations":{},"collapsed":false,"items":[{"label":"Overview","translations":{},"slug":"docs","attrs":{}},{"label":"Quickstart — VS Code","translations":{},"slug":"how-to/quickstart-vscode","attrs":{}},{"label":"Your first project","translations":{},"slug":"start/your-first-project","attrs":{}},{"label":"Verify it worked","translations":{},"slug":"start/verify-it-worked","attrs":{}},{"label":"First Observatory visit","translations":{},"slug":"start/first-observatory-visit","attrs":{}},{"label":"Set up a new project (comprehensive)","translations":{},"slug":"how-to/set-up-a-new-project","attrs":{}},{"label":"Recover from common failures","translations":{},"slug":"how-to/recover-from-common-failures","attrs":{}},{"label":"About the Observatory","translations":{},"slug":"observatory/about","attrs":{}},{"label":"Reading the Observatory","translations":{},"slug":"observatory/reading-it","attrs":{}},{"label":"Run the Observatory","translations":{},"slug":"observatory/run-it","attrs":{}},{"label":"The Observatory feed","translations":{},"slug":"observatory/feed","attrs":{}},{"label":"Open the console","translations":{},"link":"/observatory","attrs":{}},{"label":"Set up Render (platform owner)","translations":{},"slug":"how-to/set-up-render","attrs":{}},{"label":"Set up Vercel (platform owner)","translations":{},"slug":"how-to/set-up-vercel","attrs":{}},{"label":"Set up Grafana Cloud + OTel","translations":{},"slug":"how-to/set-up-grafana-cloud","attrs":{}}]},{"label":"Components","translations":{},"collapsed":false,"items":[{"label":"Observer","translations":{},"slug":"systems/observer","attrs":{}},{"label":"Memory","translations":{},"slug":"systems/memory","attrs":{}},{"label":"Telemetry","translations":{},"slug":"systems/telemetry","attrs":{}},{"label":"Registry","translations":{},"slug":"systems/registry","attrs":{}},{"label":"Observatory","translations":{},"slug":"systems/observatory","attrs":{}},{"label":"Docs MCP (planned)","translations":{},"slug":"systems/docs-mcp","attrs":{}},{"label":"The plugins","translations":{},"slug":"explanation/plugins","attrs":{}},{"label":"The memory MCP","translations":{},"slug":"explanation/memory-mcp","attrs":{}},{"label":"The discipline stack (orientation)","translations":{},"slug":"explanation/discipline-stack","attrs":{}},{"label":"Architecture snapshots","translations":{},"slug":"explanation/architecture-snapshots","attrs":{}}]},{"label":"Reference","translations":{},"collapsed":false,"items":[{"label":"OTel coordination contract","translations":{},"slug":"reference/otel-coordination-contract","attrs":{}},{"label":"Platform dependencies","translations":{},"slug":"reference/platform-dependencies","attrs":{}},{"label":"Load-bearing files","translations":{},"slug":"reference/load-bearing-files","attrs":{}}]},{"label":"Background (migrating to marketing site)","translations":{},"collapsed":false,"items":[{"label":"Project shape","translations":{},"slug":"start/project-shape","attrs":{}},{"label":"What Tapestry is not","translations":{},"slug":"start/what-tapestry-is-not","attrs":{}},{"label":"What keeps a project on track","translations":{},"slug":"start/what-stays-on-track","attrs":{}},{"label":"Project Intelligence vs Observatory","translations":{},"slug":"explanation/project-intelligence-vs-observatory","attrs":{}},{"label":"How the platform upskills itself","translations":{},"slug":"explanation/upskilling","attrs":{}},{"label":"Sharing intelligence across projects","translations":{},"slug":"explanation/sharing-intelligence-across-projects","attrs":{}}]}],"head":[{"tag":"link","attrs":{"rel":"preconnect","href":"https://fonts.googleapis.com"}},{"tag":"link","attrs":{"rel":"preconnect","href":"https://fonts.gstatic.com","crossorigin":true}},{"tag":"link","attrs":{"rel":"stylesheet","href":"https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Inter:wght@400;500;600&family=JetBrains+Mono:wght@400;500&display=swap"}}],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"Tapestry"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///C:/Users/Liz/tapestry-fd/apps/docs-site/","srcDir":"file:///C:/Users/Liz/tapestry-fd/apps/docs-site/src/","trailingSlash":"ignore"};
