...
:::tip[See also]
For the value framing — "across ten projects, you're not one operator with ten projects' worth of experience" — see [Project intelligence](/project-intelligence/). This page is the mechanism: what flows between projects, what to use it for, how to wire it on purpose.
:::
