...
**Fix:** Add the thin wrapper scripts that dispatch to the canonical implementations in `liz-patterns`. See SDE_Extraction's PR #1 (commit `2325e67`) for the pattern. The wrappers are a few lines each.
