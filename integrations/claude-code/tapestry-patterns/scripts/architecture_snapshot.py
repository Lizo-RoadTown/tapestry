...
Until the loom-discipline plugin is updated to invoke the canonical
...
def render_markdown(snapshot: dict) -> str:
    ...
    out.append(f"**Generated by:** canonical `architecture_snapshot.py` in `liz-patterns` plugin")
    out.append("")
